...
# The pawn class adds the pawn image
class Pawn(Piece):
    def __init__(self, x, y, color, dungeon):
        super().__init__(x, y, color, dungeon)
        img_path = f'images/{color}-pawn.png'
        self.img = pygame.image.load(img_path)
        self.img = pygame.transform.scale(self.img, (dungeon.tile_width, dungeon.tile_height))
        self.notation = 'p'
    ...
    def valid_moves(self):
        ...
        for move in moves:
            ...
            if tile_pos[0] < 0 or tile_pos[0] > 7 or tile_pos[-1] < 0 or tile_pos[-1] > 7:
                ...
                tile = self.dungeon.get_tile_from_pos(tile_pos)
